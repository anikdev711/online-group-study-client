    ...
    return (
        <div>
            ...
            <div className="text-center font-poppins mb-20">
                ...
                <button type="button" className="bg-secondary focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
